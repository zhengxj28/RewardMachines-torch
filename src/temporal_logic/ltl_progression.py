...
It can also progress Sequential LTL formulas such as:
    ('then', ('until','True','c'), ('until','True','d'))
...
def progress(ltl_formula, truth_assignment):
    ...
    if ltl_formula[0] == 'not':
        ...
        if result == 'True':
            ...
            #     "The following formula doesn't follow the co-safe syntactic restriction: " + str(ltl_formula))
            return ('not', result)
