...
def create_experience_replay_buffer(buffer_size, use_prioritized_replay, prioritized_replay_alpha,
...
class ReplayBuffer(object):
    ...
    def add(self, s1, a, s2, rewards, next_policies):
        data = (s1, a, s2, rewards, next_policies)
    ...
    def _encode_sample(self, idxes):
        ...
        for i in idxes:
            ...
            s1, a, s2, rewards, next_policies = data
        ...
        return np.array(S1), np.array(A), np.array(S2), np.array(Rs), np.array(NPs)
